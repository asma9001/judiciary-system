        ...
        <div className="py-4 d-none d-md-block mx-5">
          <form>
              ...
              <div className="col-md-6 ">
                <div class="form-group row text-center ">
                  ...
                  <div class="col-sm-9 d-flex ">
                    <button
                      type="button"
                      className="me-2 rounded-0  border-1 bgcustom-color fs-5 text-white"
                      style={{
                    ...
                    <button
                      ...
                      border-1 bg-transparent fs-5 text-black"
                      style={{
                        borderColor: "rgba(125, 125, 125, 1)",
                        padding: "4px 60px",
                      }}
            ...
            <div className="row mb-3">
              <div className="col-md-6 ">
                <div class="form-group row text-center">
                  <label htmlFor="deceasedFullName" class="col-sm-3 fs-6 lh-1">
            ...
            <div className="row mb-3">
              <div className="col-md-12 ">
                <div class="form-group row ">
                  <label htmlFor="deceasedFullName" class="col-sm-2 lh-1">
