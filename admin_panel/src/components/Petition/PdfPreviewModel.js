    ...
    <>
      ...
      >
        ...
        >
          ...
          >
            <div className="modal-body mt-md-3 pt-5 position-relative d-flex flex-row justify-content-between align-items-center">
              <div className=" position-absolute  close-btn-container">
               
              </div>

              <div className="d-flex text-center  justify-content-between gap-5 mx-4">
                <img src={coatArm} />
            ...
            <h3
              className="mt-2 fs-6 text-center text-decoration-underline"
...
export default PdfPreviewModel;
